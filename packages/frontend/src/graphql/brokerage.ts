...
export const PATCH_BROKERAGE_HOLDING_QUANTITY = gql`
  mutation PatchBrokerageHoldingQuantity($input: PatchHoldingQuantityInput!) {
    patchBrokerageHoldingQuantity(input: $input) {
      id
      symbol
      name
      quantity
...
export const PUT_BROKERAGE_HOLDING_QUANTITY = gql`
  mutation PutBrokerageHoldingQuantity($input: PutHoldingQuantityInput!) {
    putBrokerageHoldingQuantity(input: $input) {
      id
      symbol
      name
      quantity
